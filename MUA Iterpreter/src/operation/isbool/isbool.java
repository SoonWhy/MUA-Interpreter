package operation.isbool;

import mua.environment.environment;
import mua.variable.variable;

public class isbool {
    public String isbool(environment variableEnvironment, String a, boolean isFunc, variable closureVariable) throws Exception {
        if (a.charAt(0) == ':') {
            int flag = 0;
        ...
        return String.valueOf(a.equals("true") || a.equals("false"));
    }
}
