...
public class sqrt {
    public dataObject sqrt(environment variableEnvironment, dataObject value, boolean isFunc, variable closureVariable)throws Exception {
        ...
        if (Pattern.matches(pattern, value.getValue())) {
            ...
            return new dataObject(Double.toString(Math.sqrt(number)));
        }
        else {
